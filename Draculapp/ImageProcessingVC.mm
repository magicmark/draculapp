...
#import "ImageProcessingVC.hpp"
#import <objc/message.h>
#import "Global.h"
#import "Draculapp-Swift.h"



@interface ImageProcessingVC ()
...
- (void)frameReady:(VideoFrame)frame{
    ...
    dispatch_sync( dispatch_get_main_queue(), ^{
        ...
        if (global.STATE == 3){ // if Global State == Analytics
            ...
            //            AnalyticsVC *analytics  = [storyboard instantiateViewControllerWithIdentifier:@"AnalyticsVC"];
